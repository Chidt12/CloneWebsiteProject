...
(function($) {
    ...
    $(document).ready(function() {
            ...
            if (st > lastScrollTop){
                ...
                if (header.length) {
                    if ((windowheight > fixedheight ) && header.hasClass("sticky-header")) {
                        header.addClass('header-fixed-top').delay(1000);
                ...
                var fixedheight = topmenuheight;
                if (header.length) {
                    if ((windowheight <= fixedheight + 50) && header.hasClass("sticky-header")) {
		...
		$('.main-menu .menu li').on('click', function(){
			$('.main-menu .menu ').find('li.active').removeClass('active');
        ...
        // =============================================
        // BRAND INFO - OWL CAROUSEL
        // =============================================
        var owl = $('.brand-info-owl');
        owl.owlCarousel({
            loop: true,
            nav: true,
            dots: false,
