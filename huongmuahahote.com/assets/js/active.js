(function($) {
	...
	jQuery(document).on('ready', function(){
		...
		$('.overtop-nav .navbar-nav a').on('click', function(){
			$('.overtop-nav .navbar-nav').find('li a.active').removeClass('active');
